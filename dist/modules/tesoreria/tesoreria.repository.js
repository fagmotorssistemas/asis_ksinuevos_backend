...
exports.TesoreriaRepository = void 0;
...
class TesoreriaRepository {
    ...
    async getSaldosBancarios() {
        ...
        try {
            ...
            `;
            const result = await connection.execute(sql, [CODIGO_EMPRESA, currentYear], { outFormat: oracledb_1.default.OUT_FORMAT_OBJECT });
...
exports.TesoreriaRepository = TesoreriaRepository;
